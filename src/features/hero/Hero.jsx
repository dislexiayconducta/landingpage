    ...
    <section className="relative flex-1 bg-background-secondary flex flex-col items-center justify-center min-h-[600px] h-svh z-20">
      <div className="max-w-[1440px] mx-auto w-full flex flex-col items-center justify-center ">        
        <div className="text-background-secondary-foreground leading-none grid gap-y-0 w-full">
          <h1
            className="justify-self-start font-medium leading-[0.85] px-4 sm:px-6 lg:px-8 xl:px-20"
            style={{
          ...
          <motion.span
            className="justify-self-end block font-medium leading-[0.85] px-4 sm:px-6 lg:px-8 xl:px-20"
          ...
          <motion.span
            className="justify-self-start block font-medium leading-[0.85] px-4 sm:px-6 lg:px-8 xl:px-20"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {/* Video */}
          <div className="relative justify-self-end max-w-full w-full aspect-[16/4] lg:aspect-[16/3] overflow-hidden pl-4 sm:pl-6 lg:pl-8 xl:pl-20">
            <video
